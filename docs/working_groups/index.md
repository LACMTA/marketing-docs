...
- They will entail an iterative approach, with a product process, with priorities and backlogs, determined by the working groups. They will be a work in progress.
...
| **What’s Included** <br>**(will evolve)**                                                                                                                                                                                                                             | - Service names<br>- Signage page<br>- Fleet page<br>- Video guidelines<br>- Infographic guidelines<br>- Writing Guide? TBD | - Principles<br>- Values<br>- Vision<br>- Goals<br>- Metrics<br>- Order, Clarity, Satisfaction, Quality, Boundaries<br>- Including mapping the customer experiences, defining what is crucial in service for customers and public engagement | - Onboarding<br>- Processes<br>    - Workflows (could be another working group)<br>- Projects<br>- Software<br>- Specs<br>- Contacts | - Guiding Principles (is another working group)<br>- Brand/Identity<br>- Digital Design System (is another working group)<br>- Signage and Wayfinding<br>- Fleet<br>- Marketing Guidelines<br>- Photography<br>- Icons/Symbology<br>- Figuring out best digital platform tools | - Digital Design Toolkit<br>- Web Component Library<br>- Maintenance process<br>- Implementation (metro.net, contractor-built sites, etc.) |
| **People Interested – Working Group**||||||
| **People Interested – Contributor Capacity**|||||||
| **Roles**<br>(to develop together)<br><br>- these working groups will have the authority to set the vision<br>- define which areas are more horizontal; **pick pilot projects that require deeper-dives/kick-offs**<br>- who are decision-makers for which components||||||
...
- We’d like everyone to feel empowered to collaborate – to build the paths needed
    - Working groups can collaboratively determine roles, schedules, starting priorities, backlogs 
    - We don’t have all the answers, that’s why we need working groups to address issues together
...
- Each working group will kick-off
    - Each working group will decide how often they meet
    - Core working groups/fellowship will also provide through-lines
